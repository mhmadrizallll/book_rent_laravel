    ...
    <div class="w-50">
        ...
        <form action="book-add" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="book_code" id="code" class="form-control" autocomplete="off" value="{{old('code')}}">
            </div>
            <div class="mb-3">
                <label for="title" class="form-label">Title</label>
                <input type="text" name="title" id="title" class="form-control" placeholder="Book Name" value="{{old('title')}}">
            </div>
            <div class="mb-3">
